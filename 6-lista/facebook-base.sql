...
create table membro(
    ...
    selo integer,
    dataRegist datetime,
    foreign key(selo) references selo(id),
    foreign key(usuario) references usuario(email),
...
-- lista 6
-- a)
insert into post (usuario, datadopost, horadopost, conteudo, cidade) values('pele@cbf.com.br', '2021-06-26', '15:40:00', 'O pelé calado é um poeta, mas rapaiz', 1);
insert into post (usuario, datadopost, horadopost, conteudo, cidade) values('pele@cbf.com.br', '2021-07-28', '15:40:00', 'Golasso mano', 1);
